...
table <- tribble(
  ...
  as.character(icons::fontawesome("laptop-house")), "Office Hours", "M 1:30-2:30pm, W 10-12pm", "<a href = 'https://cuboulder.zoom.us/s/3975335005'>Zoom</a>",
  as.character(icons::fontawesome("chalkboard-teacher")), "TA", "Xiaomeng.Zhao@colorado.edu", "<a href = 'emailto:Xiaomeng.Zhao@colorado.edu'>xiaomeng.Zhao@colorado.edu</a>",
